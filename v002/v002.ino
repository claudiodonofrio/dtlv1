...
and two Thermo Couple inputs. Please be aware, you MUST use K-Type Thermocouples.
...
A0
A1
A2 = GPIP    / General Input 0-5V Channel C
A3 = GPIP    / General Input 0-5V Channel D
A4 = I2C bus / RTC
A5 = I2C bus / RTC
...
void setup()
{
  ...
  /* 
  set default timer to one second (1000 ms), since the RTC provides seconds as smallest unit
  however the reading of the sensors can be done faster and hence this timer may be
  ...
  */ 
  ...
  m_header = "Date,Time,CHA int, CHA, CHB int, CHB, CHC, CHD" ;
...
void errorCheck()
{
  ...
  {
    blink(m_led_r, 2, 200);
    m_errorcheck = false; // set to true........    
  } else
  {
    m_errorcheck = false;
  }
